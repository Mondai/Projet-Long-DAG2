...
public class RecuitSimuleParametrable implements IRecuit { 				// pas touche à cette classe !!!
	...
	public Probleme lancer(Probleme probleme) {
		...
		while (T.modifierT() && this.bestEnergy != 0) {
			...
			this.K.calculerK(deltaEnergy); 	// on reactualise K pour essayer d'avoir un deltaE/K unitaire
