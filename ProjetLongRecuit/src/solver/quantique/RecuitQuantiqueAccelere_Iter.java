 ...
 * <p>
 * Cette variante permet d'enregistrer le nombre de mutations tentées, acceptées et acceptées par la borne supèrieure.
 */
public class RecuitQuantiqueAccelere_Iter extends RecuitQuantique{ 				

	public RecuitQuantiqueAccelere_Iter(Fonction Gamma, ConstanteK K, int palier, double temperature) {
	 ...
	 * <p>
	 * Cette méthode 'lancer' variante de celle de RecuitQuantiqueAccelere prend en argument des MutableDouble (double passé en "référence" comme objet) mTentees, mAccepteesUB, mAccetpees qui enregistrent le nombre de mutations effectuées.
	 */
	public void lancer(Probleme probleme, MutableDouble mTentees, MutableDouble mAccepteesUB, MutableDouble mAcceptees) {
					...
					if(deltaEp <= 0){
						...
						if( EpActuelle < this.meilleureEnergie ){		// mettre a jour la meilleur energie
							...
							if (this.meilleureEnergie == 0){	// fin du programme
								...
								mAccepteesUB.setValue(mutationsAccepteesUB);
