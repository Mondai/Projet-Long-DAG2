...
import solver.parametres.Fonction;
	 ...
	 */
	public class RecuitQuantiqueExpf_Iter extends RecuitQuantique { 				
		 ...
		 */
		public RecuitQuantiqueExpf_Iter(Fonction Gamma, ConstanteK K, int palier, double temperature) {
